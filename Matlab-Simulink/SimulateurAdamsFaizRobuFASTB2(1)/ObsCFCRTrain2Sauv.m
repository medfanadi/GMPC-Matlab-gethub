...
if abs(delta)<2*pi/180 | abs(truc)>20 | abs(BetaF)<1*pi/180 | abs(BetaR)<1*pi/180%| abs(LF*BetaF-LR*BetaR)>0.1*vitesse/5
...
%     gain1=15;
%     GX=.8*[-.4*gain1 0 ; 0 -.05*gain1];
%     gain1=5;
%     GX=1*[-.4*gain1 0 ; 0 -.05*gain1];
    gain1=5;
    GX=1*[-4*gain1 0 ; 0 -2*gain1];
