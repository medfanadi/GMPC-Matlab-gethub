...
!
data_element create variable  &
   variable_name = .V12.PosX  &
   adams_id = 125  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.PosY  &
   adams_id = 126  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.PosXAvant  &
   adams_id = 127  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.PosYAvant  &
   adams_id = 128  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.MesureVitesse  &
   adams_id = 129  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.VitesseRoueARD  &
   adams_id = 130  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.AngleRoueARD  &
   adams_id = 131  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.AngleARG  &
   adams_id = 132  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.AngleAVG  &
   adams_id = 133  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.AngleAVD  &
   adams_id = 134  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.AngleARD  &
   adams_id = 135  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.VitesseRoueARG  &
   adams_id = 136  &
   initial_condition = 0.0  &
   function = ""
!
data_element create variable  &
   variable_name = .V12.VitesseLacet  &
   adams_id = 162  &
   initial_condition = 0.0  &
   function = ""
!
...
marker create  &
   ...
   adams_id = 138  &
   location = 7.0E+04, -3100.0, -9.0E+04  &
...
marker create  &
   ...
   adams_id = 580  &
   location = -1.89E+04, -300.0, -4.7E+04  &
   orientation = 3.1415926536, 1.5707963268, 3.1415926536
!
marker create  &
   marker_name = .V12.ground.RefMesure  &
   adams_id = 611  &
   location = -1380.0, -320.0000000026, -1059.9999999974  &
...
marker create  &
   ...
   orientation = 5.5170495068, 7.5177287238E-03, 0.7661499191
!
marker create  &
...
!
marker create  &
   marker_name = .V12.CHASSIS.CalculCap  &
   adams_id = 612  &
   location = 750.0, 200.0, -500.0  &
   orientation = 0.0, 0.0, 0.0
!
marker create  &
   marker_name = .V12.CHASSIS.MARKERRoulis  &
   adams_id = 613  &
   location = -1450.0, 0.0, -400.0  &
   orientation = 1.5707963268, 1.5707963268, 4.7123889804
!
part create rigid_body mass_properties  &
   part_name = .V12.CHASSIS  &
   mass = 300.0  &
   center_of_mass_marker = .V12.CHASSIS.MARKERREF  &
   inertia_marker = .V12.CHASSIS.MARKERREF  &
   ixx = 2.0E+08  &
   iyy = 2.0E+08  &
   izz = 2.0E+08  &
   ixy = 0.0  &
...
marker create  &
   ...
   orientation = 1.5458074817, 3.1479488901E-04, 4.7123889804
!
marker create  &
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.1943700693E-10, 0.0  &
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.1897916199E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
marker create  &
   ...
   adams_id = 114  &
   location = 7.4908057103E-05, 5.662043638E-04, 67.689322991  &
   orientation = 6.1807947326, 2.8122399792E-05, 0.1023615189
!
marker create  &
...
marker create  &
   ...
   adams_id = 115  &
   location = 452.2026304859, 4.3700383041E-10, -230.0000000003  &
   orientation = 0.0, 0.0, 0.0
!
marker create  &
...
marker create  &
   ...
   adams_id = 42  &
   location = -10.0400468207, -30.513850069, -262.7865493525  &
   orientation = 2.9261666374, 2.8961995627, 1.3632013381
!
marker create  &
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.2091425192E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.1992835979E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
marker create  &
   ...
   adams_id = 123  &
   location = 452.2026304859, 4.2621738165E-10, -230.0000000004  &
   orientation = 0.0, 0.0, 0.0
!
marker create  &
...
marker create  &
   ...
   orientation = 1.7278573184E-03, 2.3238575897, 1.7194527989E-03
!
marker create  &
...
marker create  &
   ...
   orientation = 1.1021888221E-03, 2.3300862276, 1.1530823856E-03
!
part create rigid_body mass_properties  &
   part_name = .V12.Trig_gauche  &
   density = 7.8E-07
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.2024831547E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.1766650483E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.205145337E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
geometry create shape extrusion  &
   ...
   analytical = yes  &
   points_for_profile = 0.0, 0.0, 0.0  &
      , 458.2575694956, 2.2108314347E-10, 0.0  &
      , 174.5743121886, 359.8941643371, 0.0  &
      , 0.0, 0.0, 0.0  &
   length_along_z_axis = 10.0
!
...
marker create  &
   ...
   adams_id = 588  &
   location = 2.5000002069E-09, 3.6325384001, 3.1737991623  &
...
marker create  &
   ...
   orientation = 0.0, 3.0615938858E-02, 4.7123889804
!
marker create  &
...
marker create  &
   ...
   orientation = 3.1415926536, 1.5401803879, 1.5707963268
!
marker create  &
...
marker create  &
   ...
   orientation = 0.0, 1.6014122656, 0.7745149749
!
marker create  &
...
contact create  &
   ...
   mu_static = 1.2  &
   mu_dynamic = 1.2  &
   stiction_transition_velocity = 2000.0  &
   friction_transition_velocity = 4000.0
!
contact create  &
...
simulation script create  &
   ...
   commands = "simulation single_run equilibrium model_name=.V12"
!
simulation script create  &
...
variable modify  &
   ...
   string_value = "sqrt((varval(AccelMoteur)*(1+( tan(varval(AngleBraquageAV))/Empattement )*Voie/2 ))*(varval(AccelMoteur)*(1+( tan(varval(AngleBraquageAV))/Empattement )*Voie/2 ))+(Empattement*varval(AccelMoteur)*tan(varval(AngleBraquageAV))/Empattement)*(Empattement*varval(AccelMoteur)*tan(varval(AngleBraquageAV))/Empattement))"
!
variable modify  &
...
variable modify  &
   ...
   string_value = "varval(AccelMoteur)*(1+( tan(varval(AngleBraquageAV))/Empattement )*Voie/2 )"
!
variable modify  &
...
!
geometry create shape gcontact  &
   contact_force_name = .V12.GCONTACT_5234  &
   adams_id = 5234  &
   contact_element_name = .V12.CONTACT_RR  &
   force_display = components
!
geometry attributes  &
   geometry_name = .V12.GCONTACT_5234  &
   color = YELLOW
!
!---------------------------------- Accgrav -----------------------------------!
!
...
variable create  &
   ...
   units = "angle"  &
   range = -1.745329252E-02, 1.745329252E-02  &
   use_allowed_values = no  &
   delta_type = relative  &
   real_value = 0.1243549945
!
variable create  &
...
data_element modify variable  &
   variable_name = .V12.roulis  &
   function = "ASIN( (DY(.V12.CHASSIS.MARKER_731, .V12.ground.RefMesure, .V12.ground.RefMesure)-DY( .V12.CHASSIS.MARKERRoulis, .V12.ground.RefMesure, .V12.ground.RefMesure))/ (200) )"
!
data_element modify variable  &
   variable_name = .V12.vitesse_out  &
...
data_element modify variable  &
   variable_name = .V12.PosX  &
   function = "DX(.V12.CHASSIS.cm_21, .V12.ground.RefMesure, .V12.ground.RefMesure)"
!
data_element modify variable  &
   variable_name = .V12.PosY  &
   function = "DZ( .V12.CHASSIS.cm_21, .V12.ground.RefMesure, .V12.ground.RefMesure)"
!
data_element modify variable  &
   variable_name = .V12.PosXAvant  &
   function = "DX( .V12.CHASSIS.CalculCap,.V12.ground.RefMesure, .V12.ground.RefMesure)"
!
data_element modify variable  &
   variable_name = .V12.PosYAvant  &
   function = "DZ( .V12.CHASSIS.CalculCap,.V12.ground.RefMesure, .V12.ground.RefMesure)"
!
data_element modify variable  &
   variable_name = .V12.MesureVitesse  &
   function = "SQRT( (VX( .V12.CHASSIS.cm_21, .V12.ground.RefMesure, 0 , .V12.ground.RefMesure))**2 + (VZ(  .V12.CHASSIS.cm_21, .V12.ground.RefMesure, 0 , .V12.ground.RefMesure))**2 )"
!
data_element modify variable  &
   variable_name = .V12.VitesseRoueARD  &
   function = "WZ(.V12.roue_3.MARKER_428_2, .V12.FUSE_3.MARKER_125, .V12.FUSE_3.MARKER_125)"
!
data_element modify variable  &
   variable_name = .V12.AngleRoueARD  &
   function = "AZ(.V12.FUSE_3.MARKER_588, .V12.ADD3.MARKER_587)"
!
data_element modify variable  &
   variable_name = .V12.AngleARG  &
   function = "AZ(.V12.FUSE_4.MARKER_562, .V12.ADD4.MARKER_561)"
!
data_element modify variable  &
   variable_name = .V12.AngleAVG  &
   function = "AZ(.V12.FUSE_2.MARKER_552, .V12.ADD2.MARKER_551)"
!
data_element modify variable  &
   variable_name = .V12.AngleAVD  &
   function = "AZ(.V12.FUSE.MARKER_532, .V12.ADD1.MARKER_531)"
!
data_element modify variable  &
   variable_name = .V12.AngleARD  &
   function = "AZ(.V12.FUSE_3.MARKER_588, .V12.ADD3.MARKER_587)"
...
data_element modify variable  &
   variable_name = .V12.VitesseRoueARG  &
   function = "WZ(.V12.roue_4.MARKER_427_2, .V12.FUSE_4.MARKER_127, .V12.FUSE_4.MARKER_127)"
!
data_element modify variable  &
   variable_name = .V12.VitesseLacet  &
   function = "WY(.V12.CHASSIS.cm_21, .V12.ground.RefMesure, .V12.ground.RefMesure)"
!
...
marker modify  &
   marker_name = .V12.ground.RefMesure  &
   location =   &
      (LOC_RELATIVE_TO({0, 500, -500}, .V12.CHASSIS.MARKER_503))
!
...
marker modify  &
   marker_name = .V12.CHASSIS.CalculCap  &
   location =   &
      (LOC_RELATIVE_TO({2000, 0, 0}, .V12.CHASSIS.cm_21))  &
   orientation =   &
      (ORI_RELATIVE_TO({0, 0, 0}, .V12.CHASSIS.cm_21))  &
...
measure modify computed  &
   measure_name = .V12.SPRING_3_MEA_1  &
   text_of_expression = "(.V12.SPRING_RR.deformation)"
!
measure modify computed  &
   measure_name = .V12.SPRING_4_MEA_1  &
   text_of_expression = "(.V12.SPRING_RL.deformation)"
!
measure modify computed  &
   measure_name = .V12.SPRING_2_MEA_1  &
   text_of_expression = "(.V12.SPRING_FR.deformation)"
!
measure modify computed  &
   measure_name = .V12.SPRING_MEA_1  &
   text_of_expression = "(.V12.SPRING_FL.deformation)"
!
variable modify  &
   variable_name = .V12.AngleSusp  &
